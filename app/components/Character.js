...
class Character extends React.Component {
    ...
    componentWillUnmount() {
        ...
        $(document.body).removeClass(); // Remove background image
    }

    /**
     * One last thing that is worth mentioning again is what’s happening in componentDidUpdate. If we are transitioning 
     * from one character page to another character page, we are still within the Character component, i.e. it is never 
     * unmounted. And if it isn’t unmounted, componentDidMount doesn’t fetch new character data. So in 
     * componentDidUpdate — as long as we are in the same Character component and URL paths are different, e.g. 
     * transition from /characters/1807823526 to /characters/467078888, it needs to fetch new character data.
     */
    ...
    /**
     * Since it is fairly easy to get around this restriction, it’s probably a good idea to do an IP check on the 
     * server if you do not wish to allow your users to report a character more than once.
     */
